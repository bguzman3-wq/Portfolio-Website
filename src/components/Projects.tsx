...
const projects: Project[] = [
    {
        ...
        description: "A personal portfolio website built using React and TypeScript to showcase my projects and skills. Also used C++ to create a particle effect background compiled with Emscripten to WebAssembly.",
