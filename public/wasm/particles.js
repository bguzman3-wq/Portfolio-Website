...
var _getCount = Module['_getCount'] = makeInvalidEarlyAccess('_getCount');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['getCount'] != 'undefined', 'missing Wasm export: getCount');
  ...
  _init = Module['_init'] = createExportWrapper('init', wasmExports['init'], 3);
  _step = Module['_step'] = createExportWrapper('step', wasmExports['step'], 0);
  _getX = Module['_getX'] = createExportWrapper('getX', wasmExports['getX'], 1);
  _getY = Module['_getY'] = createExportWrapper('getY', wasmExports['getY'], 1);
  _getCount = Module['_getCount'] = createExportWrapper('getCount', wasmExports['getCount'], 0);
